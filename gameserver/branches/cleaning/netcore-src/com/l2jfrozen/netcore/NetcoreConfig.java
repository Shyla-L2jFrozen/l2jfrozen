...
public class NetcoreConfig
{
	...
	{
		final String MMO_CONFIG = NetcoreConfigFiles.NETCORE_CONFIGURATION_FILE;
		...
		try
		{
			...
			SHOW_LICENCE = Boolean.parseBoolean(mmoSetting.getProperty("ShowLicence", "false"));
