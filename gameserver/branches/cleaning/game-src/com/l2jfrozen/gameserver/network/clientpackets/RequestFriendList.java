...
public final class RequestFriendList extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		 ...
		 * activeChar.sendPacket(sm); } //========================= activeChar.sendPacket(new SystemMessage(SystemMessageId.FRIEND_LIST_FOOT)); sm = null; DatabaseUtils.close(rset); DatabaseUtils.close(statement); rset = null; statement = null; } catch(Exception e) { if(CommonConfig.ENABLE_ALL_EXCEPTIONS)
