...
public class Wedding implements IVoicedCommandHandler
{
	...
	public boolean Engage(final L2PcInstance activeChar)
	{
		 ...
		 * ptarget.getObjectId()); ResultSet rset = statement.executeQuery(); while(rset.next()) { objectId = rset.getInt("friend_id"); if(objectId == activeChar.getObjectId()) { FoundOnFriendList = true; } } } catch(Exception e) { if(CommonConfig.ENABLE_ALL_EXCEPTIONS) e.printStackTrace(); LOGGER.warn(
