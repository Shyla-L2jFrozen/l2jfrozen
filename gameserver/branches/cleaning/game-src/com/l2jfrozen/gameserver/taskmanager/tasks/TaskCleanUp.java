...
{
	private final Logger LOGGER = Logger.getLogger(TaskCleanUp.class);
	private final String NAME = "cleanup";
	...
	{
		super.initializate();
		TaskManager.addUniqueTaskOnDB(NAME, TaskTypes.TYPE_FIXED_SHEDULED, "86400000", "86400000", ""); // 86400000 = 24 hours
	}
}