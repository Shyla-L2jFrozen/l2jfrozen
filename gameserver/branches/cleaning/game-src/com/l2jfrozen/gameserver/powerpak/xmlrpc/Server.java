...
public class Server
{
	 ...
	 * @return
	 */
	public int addItem(final String key, final String charName, final String itemId, final String count, final String message)
	{
	 ...
	 */
	public int addItemToCharacter(final String charName, final String itemId, final String count, final String message)
	{
		int output = 0;
