...
public class L2PlayerAI extends L2CharacterAI
{
	...
	{
		/*
		 * if (CommonConfig.DEBUG) LOGGER.warn("L2PlayerAI: changeIntention -> " + intention + " " + arg0 + " " + arg1);
		 */
		...
		/*
		 * if (CommonConfig.DEBUG) LOGGER.warn("L2PlayerAI: changeIntention -> Saving current intention: " + _intention + " " + _intention_arg0 + " " + _intention_arg1);
		 */
	...
	protected void onEvtFinishCasting()
	{
		...
		if (getIntention() == AI_INTENTION_CAST)
		{
			...
			if (!getInterruptedIntentions().isEmpty())
			{
				...
				/*
				 * if (CommonConfig.DEBUG) LOGGER.warn("L2PlayerAI: onEvtFinishCasting -> " + cmd._intention + " " + cmd._arg0 + " " + cmd._arg1);
				 */
			...
			{
				/*
				 * if (CommonConfig.DEBUG) LOGGER.warn("L2PlayerAI: no previous intention set... Setting it to IDLE");
				 */
	...
	private void thinkCast()
	{
		...
		final L2Skill skill = get_skill();
		// if (CommonConfig.DEBUG) LOGGER.warn("L2PlayerAI: thinkCast -> Start");
