...
abstract class AbstractAI implements Ctrl
{
	...
	{
		/*
		 * if (CommonConfig.DEBUG) LOGGER.warn("AbstractAI: changeIntention -> " + intention + " " + arg0 + " " + arg1);
		 */
	...
	public final void setIntention(final CtrlIntention intention, final Object arg0, final Object arg1)
	{
		...
		/*
		 * if (CommonConfig.DEBUG) LOGGER.warn("AbstractAI: setIntention -> " + intention + " " + arg0 + " " + arg1);
		 */
