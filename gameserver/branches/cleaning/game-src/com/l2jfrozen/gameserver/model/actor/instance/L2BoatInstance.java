...
public class L2BoatInstance extends L2Character
{
	...
	public void moveToLocation(final int x, final int y, final int z, final float speed)
	{
		...
		/*
		 * if(CommonConfig.DEBUG) { _logBoat.fine("distance to target:" + distance); }
		 */
		...
		/*
		 * if(CommonConfig.DEBUG) { _logBoat.fine("dist:" + distance + "speed:" + speed + " ttt:" + ticksToMove + " heading:" + getPosition().getHeading()); }
		 */
		...
		/*
		 * if(CommonConfig.DEBUG) { _logBoat.fine("time to target:" + ticksToMove); }
		 */
