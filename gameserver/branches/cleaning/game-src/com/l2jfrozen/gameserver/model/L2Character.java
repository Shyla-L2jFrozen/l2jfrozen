...
public abstract class L2Character extends L2Object implements ISkillsHolder
{
	...
	protected void moveToLocation(int x, int y, int z, int offset)
	{
		...
		/*
		 * if(CommonConfig.DEBUG) { LOGGER.fine("distance to target:" + distance); }
		 */
		...
		/*
		 * if(CommonConfig.DEBUG) { LOGGER.fine("dist:" + distance + "speed:" + speed + " ttt:" + ticksToMove + " heading:" + getHeading()); }
		 */
		...
		/*
		 * if(CommonConfig.DEBUG) { LOGGER.fine("time to target:" + ticksToMove); }
		 */
				...
				if (!isBow) // Do not reflect or absorb if weapon is of type bow
				{
					...
					if (absorbPercent > 0)
					{
						...
						if (absorbDamage > 0)
						{
							...
							/*
							 * if (this instanceof L2PcInstance) ((L2PcInstance)this).sendMessage("You absorbed " + absorbDamage + " damage."); else if (this instanceof L2Summon) ((L2Summon)this).getOwner().sendMessage("Summon absorbed " + absorbDamage + " damage."); else if (CommonConfig.DEBUG)
	...
	// {
	// if (CommonConfig.DEBUG) LOGGER.fine("Checking PvpFlag");
