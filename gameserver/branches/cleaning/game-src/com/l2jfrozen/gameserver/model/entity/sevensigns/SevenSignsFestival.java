...
public class SevenSignsFestival implements SpawnListener
{
	...
	private class L2DarknessFestival
	{
		...
		/*
		 * public void setSpawnRate(int respawnDelay) { if (CommonConfig.DEBUG) LOGGER.info("SevenSignsFestival: Modifying spawn rate of festival mobs to " + respawnDelay + " ms for festival " + SevenSigns.getCabalShortName(_cabal) + " (" + getFestivalName(_levelRange) + ")"); for
