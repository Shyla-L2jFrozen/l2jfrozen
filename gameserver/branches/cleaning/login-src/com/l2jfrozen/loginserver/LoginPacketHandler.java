...
{
	private final Logger LOGGER = Logger.getLogger(LoginPacketHandler.class);
	
	@Override
	public ReceivablePacket<LoginClient> handlePacket(final ByteBuffer buf, final LoginClient client)
	{
