...
public final class LoginClient extends MMOClient<MMOConnection<LoginClient>>
{
	 ...
	 * @param con
	 */
	public LoginClient(final MMOConnection<LoginClient> con)
	{
		super(con);
		_state = LoginClientState.CONNECTED;
		final String ip = getConnection().getInetAddress().getHostAddress();
		_ip = ip;
		final String[] localip = LoginConfig.NETWORK_IP_LIST.split(";");
		...
		{
			LoginController.getInstance().addBanForAddress(getConnection().getInetAddress(), LoginConfig.BRUT_BAN_IP_TIME * 1000);
