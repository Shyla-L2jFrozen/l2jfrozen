...
public class BruteProtector
{
	...
	public static boolean canLogin(final String ip)
	{
		 ...
		 */
		if (_clients.get(ip).size() < LoginConfig.BRUT_LOGON_ATTEMPTS) // Performing checks only after BRUT_LOGON_ATTEMPTS logon attempts
			return true;
		...
		if (avg < LoginConfig.BRUT_AVG_TIME)
		{
