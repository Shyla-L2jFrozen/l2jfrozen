...
public class L2NpcInstance extends L2Character
{
	 ...
	 * HtmCache.getInstance().getHtm(path); if(CommonConfig.DEBUG) { if(content != null) { LOGGER.fine("Showing quest window for quest " + questId + " html path: " + path); } else { LOGGER.fine("File not exists for quest " + questId + " html path: " + path); } } qs = null; } // Send a Server->Client
