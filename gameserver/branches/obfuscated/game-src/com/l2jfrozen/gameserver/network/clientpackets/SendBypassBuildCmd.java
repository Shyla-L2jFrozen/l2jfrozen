...
public final class SendBypassBuildCmd extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			if (Config.GMAUDIT)
				GMAudit.auditGMAction(activeChar.getName() + " [" + activeChar.getObjectId() + "]", activeChar.getClient().gco().getInetAddress().getHostAddress(), _command, (activeChar.getTarget() != null ? activeChar.getTarget().getName() : "no-target"));
