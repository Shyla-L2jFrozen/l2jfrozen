...
public class ClientSetTime extends L2GameServerPacket
{
	...
	{
		C(0xEC);
		D(GameTimeController.getInstance().getGameTime()); // time in client minutes
		D(6); // constant to match the server time( this determines the speed of the client clock)
	}
