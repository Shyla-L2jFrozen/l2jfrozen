...
public class PetItemList extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		for (final L2ItemInstance temp : items)
		{
			H(temp.getItem().getType1()); // item type1
			D(temp.getObjectId());
			D(temp.getItemId());
			D(temp.getCount());
			H(temp.getItem().getType2()); // item type2
			H(0xff); // ?
			if (temp.isEquipped())
			{
				H(0x01);
			...
			D(temp.getItem().getBodyPart()); // rev 415 slot 0006-lr.ear 0008-neck 0030-lr.finger 0040-head 0080-?? 0100-l.hand 0200-gloves 0400-chest 0800-pants 1000-feet 2000-?? 4000-r.hand 8000-r.hand
			...
			H(temp.getEnchantLevel()); // enchant level
			H(0x00); // ?
		}
	}
