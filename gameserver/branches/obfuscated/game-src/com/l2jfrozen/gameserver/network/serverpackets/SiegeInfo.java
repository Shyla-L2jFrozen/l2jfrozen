...
public class SiegeInfo extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		D(_castle.getOwnerId() == activeChar.getClanId() && activeChar.isClanLeader() ? 0x01 : 0x00);
		D(_castle.getOwnerId());
		...
		D((int) (_castle.getSiege().getSiegeDate().getTimeInMillis() / 1000));
