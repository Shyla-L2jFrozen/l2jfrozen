...
public class L2DatabaseFactory_c3p0 extends L2DatabaseFactory
{
	...
	public L2DatabaseFactory_c3p0() throws SQLException
	{
		try
		{
			if (Config.DATABASE_MAX_CONNECTIONS < 2)
			{
				...
				_log.severe(" [ERROR] [WARNING]A minimum of " + Config.DATABASE_MAX_CONNECTIONS + " db connections are required.");
			}
			...
			_log.fine(" [FINE] Database Connection Working");
			
			_providerType = ProviderType.MySql;
		}
		catch (SQLException x)
		{
			_log.fine(" [FINE] Database Connection FAILED");
	...
	{ 
		...
		while(con == null && _source!=null)
		{
			...
			{
				_log.severe(" [ERROR] [ERROR]L2DatabaseFactory: getConnection() failed, trying again" + e);
			}
		}
	...
	{ 
		...
		while(con == null && _source!=null)
		{
			...
			catch(SQLException e)
			{
				...
				_log.severe(" [ERROR] [ERROR]L2DatabaseFactory: getConnection() failed, trying again \n" + e);
			}
		}
